<%-- 
    ...
    Created on : Nov 2, 2021, 1:05:57 PM
    Author     : Admin
--%>
        ...
        <div class="content">
            ...
            <div class="login">
                <form action="createaccount" method="post">
                    ...
                    <input type="text" name="user" placeholder="Tên đăng nhập"  value="${requestScope.userc}"/><br/>
                    <span>Mật khẩu:</span><br/>
                    <input type="password" name="pass" placeholder="Mật khẩu" /><br/>
                    <span>Nhập lại mật khẩu:</span><br/>
                    <input type="password" name="repass" placeholder="Mật khẩu" /><br/>
                    <button type="submit">Đăng kí</button>
                    <a class="ret" href="login.jsp">Quay lại đăng nhập</a>
                </form>
            </div>
        </div>
    </body>
